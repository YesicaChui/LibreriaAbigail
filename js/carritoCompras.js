    ...
    <div class="card m-2">
      <div class="card-body text-center d-grid gap-2">
        <div class="d-flex justify-content-between">
          ...
          <h5 class="card-text fw-bold" >S/. <span id="montoTotalCarrito">${carrito.reduce((acumulador,elemento)=>acumulador+elemento.precio*elemento.cantidad,0)}</span></h5>
        </div>
...
//version anterior cuando se duplicaban los productos en el carrito
...
function cargarProductosCarrito(){
  ...
  carrito.forEach((producto,index)=>{     
          ...
          <div class="card-body d-flex flex-row align-items-center justify-content-between">
            ...
            <p class="card-text m-0 ">S/ <span id="subtotalCarrito${producto.id}">${producto.precio*producto.cantidad}</span></p>
            <div id="buttonsAdmin" class="d-flex justify-content-between">
              <button type="button" class="btn btn-outline-danger" id="btnBorrar${producto.id}" style="width: 50px;height:40px"><img src="https://cdn-icons-png.flaticon.com/512/54/54324.png" style="width: 20px;height:20px" alt=""></button>          
            </div>
          </div>
...
const reCalculoMonto=()=>{
  ...
  textoMontoTotal.innerText=carrito.reduce((acumulador,elemento)=>acumulador+elemento.precio*elemento.cantidad,0)
}
